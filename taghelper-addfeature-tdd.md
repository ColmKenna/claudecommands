...
**REQUIRED FORMAT:** `Given_When_Then`

**Examples for Feature Addition:**
- `GivenOnDeleteCallbackIsSet_WhenProcessing_ThenInvokesCallbackWithContext`
- `GivenCallbackIsNull_WhenProcessing_ThenDoesNotThrowException`
- `GivenInvalidCallbackSignature_WhenProcessing_ThenThrowsInvalidOperationException`

**Alternative Shorter Format:** `GivenCondition_WhenAction_ThenOutcome` can be simplified when context is clear:
- `Given_OnDeleteCallback_InvokesCallbackWithContext`
- `Given_NullCallback_DoesNotThrow`

### Test Structure for New Features

```csharp
[Fact]
public async Task Given_NewFeatureProperty_When_Processing_Then_OutputContainsExpectedAttribute()
{
    // Given - Setup with NEW feature properties
    ...
    // Then - Verify NEW feature behavior
